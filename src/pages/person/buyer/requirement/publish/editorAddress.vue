        ...
        <div class="address-form">
          ...
          <div class="form clearfix">
            ...
            <div class="info">
              ...
              <el-select v-model="city" @change="cityChoose(city)" placeholder="城市">
                <el-option
              ...
              <el-select v-model="area" @change="areaChoose(area)" placeholder="区域/乡镇">
                <el-option
  ...
  export default {
    ...
    created() {
      ...
      fetchCityList({id: '22'}).then((res) => {
        ...
        if (id !== undefined) {
          fetchAddressById({companyId: this.userInfo.companyId, addressId: this.$route.query.id}).then((res) => {
            const data = res.data.data
    ...
    methods: {
      isShow (scope) {
        ...
        fetchAddressById({companyId: this.userInfo.companyId, addressId: scope.addressId}).then((res) => {
          if (res.data.code === 200) {
            let data = res.data.data
            this.provinceId = data.provinceCode
            this.cityId = data.cityCode
            this.areaId = data.areaCode
      ...
      saveInfo() {
        ...
        fetchModifyAddress(param).then((res) => {
          this.loading = false
          if (res.data.code === 200) {
            this.$emit('editorAddressSuccess')
          }
        }, () => {
          this.loading = false
        })
